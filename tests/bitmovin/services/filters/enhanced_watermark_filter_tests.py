...
from bitmovin import Bitmovin, Response, WatermarkFilter, WatermarkUnit, EnhancedWatermarkFilter
...
class EnhancedWatermarkFilterTests(BitmovinTestCase):
    ...
    def test_create_enchanced_watermark_filter(self):
        ...
        filter_resource_response = self.bitmovin.filters.EnhancedWatermark.create(sample_filter)
    ...
    def test_retrieve_enchanced_watermark_filter(self):
        sample_filter = self._get_sample_enchanced_watermark_filter()
        created_filter_response = self.bitmovin.filters.EnhancedWatermark.create(sample_filter)
        ...
        retrieved_filter_response = self.bitmovin.filters.EnhancedWatermark.retrieve(
    ...
    def test_delete_enchanced_watermark_filter(self):
        ...
        deleted_minimal_resource = self.bitmovin.filters.EnhancedWatermark.delete(created_filter_response.resource.id)
        self.assertIsNotNone(deleted_minimal_resource)
        self.assertIsNotNone(deleted_minimal_resource.resource)
        self.assertIsNotNone(deleted_minimal_resource.resource.id)

        try:
            self.bitmovin.filters.EnhancedWatermark.retrieve(created_filter_response.resource.id)
            self.fail(
    ...
    def test_list_enchanced_watermark_filters(self):
        ...
        filters = self.bitmovin.filters.EnhancedWatermark.list()
    ...
    def test_retrieve_enchanced_watermark_filter_custom_data(self):
        ...
        custom_data_response = self.bitmovin.filters.EnhancedWatermark.retrieve_custom_data(
            created_filter_response.resource.id)
