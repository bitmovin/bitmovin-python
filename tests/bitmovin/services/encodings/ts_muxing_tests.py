...
class EncodingTSMuxingTests(BitmovinTestCase):
    ...
    def test_retrieve_muxing(self):
        ...
        retrieved_muxing_response = self.bitmovin.encodings.Muxing.TS.retrieve(
    ...
    def test_delete_muxing(self):
        ...
        deleted_minimal_resource = self.bitmovin.encodings.Muxing.TS.delete(
        ...
        try:
            self.bitmovin.encodings.Muxing.TS.retrieve(created_muxing_response.resource.id)
            self.fail(
    ...
    def test_list_muxings(self):
        ...
        muxings = self.bitmovin.encodings.Muxing.TS.list(encoding_id=self.sampleEncoding.id)
    ...
    def test_retrieve_stream_custom_data(self):
        ...
        custom_data_response = self.bitmovin.encodings.Muxing.TS.retrieve_custom_data(
            muxing_id=created_muxing_response.resource.id,
            encoding_id=self.sampleEncoding.id)
    ...
    def test_retrieve_stream_status(self):
        ...
        muxing_status_response = self.bitmovin.encodings.Muxing.TS.retrieve_status(
            muxing_id=created_muxing_response.resource.id,
            encoding_id=self.sampleEncoding.id)
