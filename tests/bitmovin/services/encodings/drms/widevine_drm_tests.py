...
class WidevineDRMTests(BitmovinTestCase):
    ...
    def test_retrieve_drm(self):
        ...
        retrieved_drm_response = self.bitmovin.encodings.Muxing.FMP4.DRM.Widevine.retrieve(
    ...
    def test_delete_drm(self):
        ...
        deleted_minimal_resource = self.bitmovin.encodings.Muxing.FMP4.DRM.Widevine.delete(
        ...
        try:
            self.bitmovin.encodings.Muxing.FMP4.DRM.Widevine.retrieve(encoding_id=self.sampleEncoding.id,
    ...
    def test_list_drms(self):
        ...
        drms = self.bitmovin.encodings.Muxing.FMP4.DRM.Widevine.list(encoding_id=self.sampleEncoding.id,
    ...
    def test_retrieve_stream_custom_data(self):
        ...
        custom_data_response = self.bitmovin.encodings.Muxing.FMP4.DRM.Widevine.retrieve_custom_data(
            muxing_id=fmp4_muxing.id,
    ...
    def test_retrieve_drm_status(self):
        ...
        drm_status_response = self.bitmovin.encodings.Muxing.FMP4.DRM.Widevine.retrieve_status(
            muxing_id=fmp4_muxing.id,
            encoding_id=self.sampleEncoding.id,
            drm_id=drm_resource.id
        )
    ...
    def _compare_drms(self, first: WidevineDRM, second: WidevineDRM):
        """
    ...
    def _get_sample_drm_widevine(self):
        widevine_drm_settings = self.settings.get('sampleObjects').get('drmConfigurations').get('Widevine')
