...
class MarlinDRMTests(BitmovinTestCase):
    ...
    def test_retrieve_drm(self):
        ...
        retrieved_drm_response = self.bitmovin.encodings.Muxing.FMP4.DRM.Marlin.retrieve(
    ...
    def test_retrieve_drm_sample_marlin(self):
        fmp4_muxing = self._create_muxing()
        self.assertIsNotNone(fmp4_muxing.id)
        sample_drm = self._get_sample_drm_marlin()
        sample_drm.outputs = fmp4_muxing.outputs
    ...
    def test_delete_drm(self):
        ...
        deleted_minimal_resource = self.bitmovin.encodings.Muxing.FMP4.DRM.Marlin.delete(
        ...
        try:
            self.bitmovin.encodings.Muxing.FMP4.DRM.Marlin.retrieve(encoding_id=self.sampleEncoding.id,
    ...
    def test_list_drms(self):
        ...
        drms = self.bitmovin.encodings.Muxing.FMP4.DRM.Marlin.list(encoding_id=self.sampleEncoding.id,
                                                                   muxing_id=fmp4_muxing.id)
    ...
    def test_retrieve_stream_custom_data(self):
        ...
        custom_data_response = self.bitmovin.encodings.Muxing.FMP4.DRM.Marlin.retrieve_custom_data(
            muxing_id=fmp4_muxing.id,
            encoding_id=self.sampleEncoding.id,
    ...
    def test_retrieve_drm_status(self):
        ...
        drm_status_response = self.bitmovin.encodings.Muxing.FMP4.DRM.Marlin.retrieve_status(
            muxing_id=fmp4_muxing.id,
            encoding_id=self.sampleEncoding.id,
            drm_id=drm_resource.id
        )
