import unittest
import json
from bitmovin import Bitmovin, Response, VorbisCodecConfiguration, ChannelLayout
from bitmovin.errors import BitmovinApiError
from tests.bitmovin import BitmovinTestCase


class VorbisCodecConfigurationTests(BitmovinTestCase):
    ...
    def test_create_codec_configuration(self):
        ...
        codec_configuration_resource_response = self.bitmovin.codecConfigurations.Vorbis.create(
    ...
    def test_retrieve_codec_configuration(self):
        sample_codec_configuration = self._get_sample_codec_configuration()
        created_codec_configuration_response = self.bitmovin.codecConfigurations.Vorbis.create(
            sample_codec_configuration)
        ...
        retrieved_codec_configuration_response = self.bitmovin.codecConfigurations.Vorbis.retrieve(
    ...
    def test_delete_codec_configuration(self):
        ...
        deleted_minimal_resource = self.bitmovin.codecConfigurations.Vorbis.delete(
            created_codec_configuration_response.resource.id)
        ...
        try:
            self.bitmovin.codecConfigurations.Vorbis.retrieve(created_codec_configuration_response.resource.id)
            self.fail(
    ...
    def test_list_codec_configurations(self):
        ...
        codec_configurations = self.bitmovin.codecConfigurations.Vorbis.list()
    ...
    def test_retrieve_codec_configuration_custom_data(self):
        ...
        custom_data_response = self.bitmovin.codecConfigurations.Vorbis.retrieve_custom_data(
            created_codec_configuration_response.resource.id)
        custom_data = custom_data_response.resource

        self.assertEqual(sample_codec_configuration.customData, json.loads(custom_data.customData))

    def _compare_codec_configurations(self, first: VorbisCodecConfiguration, second: VorbisCodecConfiguration):
        """
    ...
    def _get_sample_codec_configuration(self):
        codec_configuration = VorbisCodecConfiguration(name='Python - Sample Vorbis Codec Configuration',
