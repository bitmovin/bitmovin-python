...
from bitmovin import Bitmovin, Response, HeAACv2CodecConfiguration, AACChannelLayout, HeAacCodecConfigSignaling
from bitmovin.errors import BitmovinApiError
from tests.bitmovin import BitmovinTestCase


class HeAACV2CodecConfigurationTests(BitmovinTestCase):
    ...
    def test_create_he_v2_aac_codec_configuration(self):
    ...
    def test_retrieve_he_v2_aac_codec_configuration(self):
        ...
        retrieved_codec_configuration_response = self.bitmovin.codecConfigurations.HeAACv2.retrieve(
        ...
        self._compare_he_v2_aac_codec_configurations(created_codec_configuration_response.resource,
                                                     retrieved_codec_configuration_response.resource)

    def test_delete_he_v2_aac_codec_configuration(self):
        sample_codec_configuration = self._get_sample_he_v2_aac_codec_configuration()
        created_codec_configuration_response = self.bitmovin.codecConfigurations.HeAACv2.create(
            sample_codec_configuration)
        self.assertIsNotNone(created_codec_configuration_response)
        ...
        deleted_minimal_resource = self.bitmovin.codecConfigurations.HeAACv2.delete(
            created_codec_configuration_response.resource.id)
        ...
        try:
            self.bitmovin.codecConfigurations.HeAACv2.retrieve(created_codec_configuration_response.resource.id)
            self.fail(
    ...
    def test_list_he_v2_aac_codec_configurations(self):
        sample_codec_configuration = self._get_sample_he_v2_aac_codec_configuration()
        created_codec_configuration_response = self.bitmovin.codecConfigurations.HeAACv2.create(
            sample_codec_configuration)
        self.assertIsNotNone(created_codec_configuration_response)
        ...
        codec_configurations = self.bitmovin.codecConfigurations.HeAACv2.list()
    ...
    def test_retrieve_he_v2_aac_codec_configuration_custom_data(self):
        sample_codec_configuration = self._get_sample_he_v2_aac_codec_configuration()
        ...
        custom_data_response = self.bitmovin.codecConfigurations.HeAACv2.retrieve_custom_data(
            created_codec_configuration_response.resource.id)
        custom_data = custom_data_response.resource

        self.assertEqual(sample_codec_configuration.customData, json.loads(custom_data.customData))

    def _compare_he_v2_aac_codec_configurations(self, first: HeAACv2CodecConfiguration,
                                                second: HeAACv2CodecConfiguration):
        """

        :param first: HeAACv2CodecConfiguration
        :param second: HeAACv2CodecConfiguration
        :return: bool
        """
