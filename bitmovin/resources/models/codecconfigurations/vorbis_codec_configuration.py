...
class VorbisCodecConfiguration(AudioCodecConfiguration, Serializable):
    ...
    def parse_from_json_object(cls, json_object):
        ...
        vorbis_codec_configuration = VorbisCodecConfiguration(id_=id_,
                                                              name=name,
        ...
        return vorbis_codec_configuration
