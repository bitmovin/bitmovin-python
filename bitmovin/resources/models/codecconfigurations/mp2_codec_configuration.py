...
class MP2CodecConfiguration(AudioCodecConfiguration, Serializable):
    ...
    def channelLayout(self, new_layout):
        ...
        elif isinstance(new_layout, MP2ChannelLayout):
            self._channelLayout = new_layout.value
        else:
            raise InvalidTypeError(
                'Invalid type {} for channelLayout: must be either str or MP2ChannelLayout!'.format(type(new_layout)))
