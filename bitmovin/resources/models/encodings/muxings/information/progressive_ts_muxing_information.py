...
class ProgressiveTsMuxingInformation(Serializable):
    ...
    def serialize(self):
        ...
        serialized['videoTracks'] = self._video_tracks.serialize()
        serialized['audioTracks'] = self._audio_tracks.serialize()
        return serialized
