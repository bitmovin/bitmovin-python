...
class BroadcastTsAudioStreamConfiguration(BroadcastTsInputStreamConfiguration):
    ...
    def parse_from_json_object(cls, json_object):
        ...
        return BroadcastTsAudioStreamConfiguration(
            ...
            align_pes=input_stream_configuration.alignPes, set_rai_on_au=input_stream_configuration.setRaiOnAu,
            use_atsc_buffer_model=use_atsc_buffer_model, language=language
        )
