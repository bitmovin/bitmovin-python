...
class RawID3Tag(ID3Tag):
    ...
    def __init__(self, position_mode, bytes, time=None, frame=None, id_=None, custom_data=None, name=None, description=None):
    ...
    def parse_from_json_object(cls, json_object):
        ...
        bytes = json_object.get('bytes')

        raw_id3_tag = RawID3Tag(bytes=bytes, position_mode=position_mode, time=time, frame=frame,
