...
class ClosedCaptionsMedia(AbstractStandardMedia):
    ...
    def __init__(self, name, group_id, segment_path, encoding_id, stream_id, muxing_id, drm_id=None,
                 ...
                 is_default=None, autoselect=None, characteristics=None, instream_id=None, id_=None):
    ...
    def parse_from_json_object(cls, json_object):
        ...
        instream_id = json_object.get('instreamId')

        closed_captions_media = ClosedCaptionsMedia(id_=id_, name=name, group_id=group_id, language=language,
                                                    ...
                                                    end_segment_number=end_segment_number, instream_id=instream_id)
