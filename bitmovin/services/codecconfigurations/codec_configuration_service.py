...
from .eac3_codec_configuration_service import EAC3
...
from .mp3_codec_configuration_service import MP3
from .av1_codec_configuration_service import AV1
from .opus_codec_configuration_service import Opus
from .vorbis_codec_configuration_service import Vorbis
...
class CodecConfigurationService(BitmovinObject):
    def __init__(self, http_client):
        ...
        self.EAC3 = EAC3(http_client=self.http_client)
        self.MP2 = MP2(http_client=self.http_client)
        self.MP3 = MP3(http_client=self.http_client)
        ...
        self.Vorbis = Vorbis(http_client=self.http_client)
