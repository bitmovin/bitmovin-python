...
from bitmovin.resources.models import IngestInputStream as IngestInputStreamResource
from ..rest_service import RestService


class IngestInputStream(RestService):
    BASE_ENDPOINT_URL = 'encoding/encodings/{encoding_id}/input-streams/ingest'

    def __init__(self, http_client):
        super().__init__(http_client=http_client, relative_url=self.BASE_ENDPOINT_URL, class_=IngestInputStreamResource)
