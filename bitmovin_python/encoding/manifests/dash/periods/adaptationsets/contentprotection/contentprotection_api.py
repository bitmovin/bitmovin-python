...
from bitmovin_python.encoding.manifests.dash.periods.adaptationsets.contentprotection.content_protections_list_query_params import ContentProtectionsListQueryParams
...
class ContentprotectionApi(BaseApi):
    ...
    def create(self, manifest_id, period_id, adaptationset_id, content_protection=None, **kwargs):
    ...
    def list(self, manifest_id, period_id, adaptationset_id, query_params: ContentProtectionsListQueryParams = None, **kwargs):
