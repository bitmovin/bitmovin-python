...
from bitmovin_python.encoding.manifests.dash.periods.adaptationsets.subtitle.subtitle_adaptation_sets_list_query_params import SubtitleAdaptationSetsListQueryParams
...
class SubtitleApi(BaseApi):
    ...
    def create(self, manifest_id, period_id, subtitle_adaptation_set=None, **kwargs):
    ...
    def list(self, manifest_id, period_id, query_params: SubtitleAdaptationSetsListQueryParams = None, **kwargs):
