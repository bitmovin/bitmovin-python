...
encoding_profiles_h264 = [
    dict(height=240, height_landscape=426, bitrate=400, fps=None, profile=H264Profile.HIGH),
    dict(height=360, height_landscape=640, bitrate=800, fps=None, profile=H264Profile.HIGH),
    dict(height=480, height_landscape=852, bitrate=1200, fps=None, profile=H264Profile.HIGH),
    dict(height=720, height_landscape=1280, bitrate=2400, fps=None, profile=H264Profile.HIGH),
    dict(height=1080, height_landscape=1920, bitrate=4800, fps=None, profile=H264Profile.HIGH),
]
